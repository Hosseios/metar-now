      ...
      <div className="relative h-96 overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-between p-6">
          <div className="flex items-center space-x-4">
            <div className="relative">
              <img src="/lovable-uploads/f3b806b3-e3b6-42ae-8d42-b8f9eaa7dc5a.png" alt="Logo" className="w-16 h-16 rounded-full shadow-xl ring-4 ring-white/30 backdrop-blur-sm" />
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center space-y-6 px-6">
            <h2 className="text-5xl md:text-6xl font-bold text-white drop-shadow-2xl">Real-Time METAR Reports</h2>
